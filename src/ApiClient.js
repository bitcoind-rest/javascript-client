...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.BitcoindRestClient.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default http://localhost:3000/rest
     */
    this.basePath = 'http://localhost:3000/rest'.replace(/\/+$/, '');
