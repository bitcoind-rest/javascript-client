...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitcoindRestClient.TransactionApi();
  });
  ...
  describe('TransactionApi', function() {
    describe('restTx', function() {
      it('should call restTx successfully', function(done) {
        //uncomment below and update the code to test restTx
        //instance.restTx(function(error) {
