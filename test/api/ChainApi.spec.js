...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BitcoindRestClient.ChainApi();
  });
  ...
  describe('ChainApi', function() {
    describe('restChaininfo', function() {
      it('should call restChaininfo successfully', function(done) {
        //uncomment below and update the code to test restChaininfo
        //instance.restChaininfo(function(error) {
